<x-ui.cards.title-on-top>
    ...
    <x-slot name="description">
        Atur dan keluar dari sesi di browser dan perangka lain
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            Jika perlu, Anda dapat keluar dari semua sesi browser Anda yang lain di semua perangkat Anda. Jika Anda
            merasa akun Anda telah dibobol, Anda juga dapat memperbarui kata sandi Anda.
        </div>
