...
@if (Gate::check('addTeamMember', $team))
    ...
    <!-- Add Team Member -->
        <div class="mt-10 sm:mt-0">
            ...
            <x-ui.forms.card submit="addTeamMember">
                <x-slot name="header">
                    <h2
                        class="text-lg leading-6 font-medium text-gray-900">Tambahkan anggota workspace</h2>
                    <p class="mt-1 text-sm leading-5 text-gray-500">Silahkan tambahkan anggota workspace, untuk berkolaborasi
                        dalam membuat workspace.</p>
                </x-slot>
