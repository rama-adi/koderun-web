...
<x-menu-item :active="Route::is('scratchbook.*')" href="{{route('scratchbook.index')}}">
    <x-slot name="icon">
...
<x-menu-item :active="Route::is('starred')" href="{{route('starred')}}">
    <x-slot name="icon">
        <x-heroicon-o-star />
    </x-slot>
    <x-slot name="title">Scratchbook dibintangi</x-slot>
</x-menu-item>
